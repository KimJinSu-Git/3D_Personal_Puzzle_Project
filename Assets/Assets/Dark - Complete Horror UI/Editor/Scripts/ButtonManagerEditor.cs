...
//
//             if (bTarget.fixWidth == true)
//                 bTarget.UpdateUIEditor();
//         }
//
...
//             var fixWidth = serializedObject.FindProperty("fixWidth");
//
//             switch (currentTab)
//             {
//                 case 0:
...
//                     GUILayout.BeginHorizontal(EditorStyles.helpBox);
//
//                     fixWidth.boolValue = GUILayout.Toggle(fixWidth.boolValue, new GUIContent("Fix Width Issues"), customSkin.FindStyle("Toggle"));
//                     fixWidth.boolValue = GUILayout.Toggle(fixWidth.boolValue, new GUIContent(""), customSkin.FindStyle("Toggle Helper"));
//
//                     GUILayout.EndHorizontal();
//                     GUILayout.BeginHorizontal(EditorStyles.helpBox);
//
